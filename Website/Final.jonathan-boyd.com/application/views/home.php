...
<body>
<ul>
  <li><a class="active" href="http://final.jonathan-boyd.com/index.php/pages">Home</a></li>
...
<h1>Home</h1>
<br/><br/>
<h3>This is the final project home page. Using the header bar you can navigate to all the sites required for the final. Input information to a database using the "Forms" page and retrieve it on the "Autocomplete" page. On the "API 1" page we have a simple google map intergration. On "API 2" there is an interactive google pie chart that is linked to a database to display favorte colors.</h3>
...
h3 {text-align: left; background-color:; color: ;}
